...
public final class RetrofitTest {
  ...
  interface CallMethod {
    ...
    @GET("/") Call<ResponseBody> queryString(@Variable("foo") String foo);
    @GET("/") Call<ResponseBody> queryObject(@Variable("foo") Object foo);
  }
  ...
  interface Annotated {
    ...
    @GET("/") Call<ResponseBody> queryParameter(@Foo @Variable("foo") Object foo);

    @Retention(RUNTIME)
    @interface Foo {}
  }
  interface MutableParameters {
    @GET("/{?i}") Call<String> method(@Variable("i") AtomicInteger value);
  }
